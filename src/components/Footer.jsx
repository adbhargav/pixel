      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 w-full">
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/gallery" className="text-sm hover:text-gray-400 transition">Gallery</a></li>
            <li><a href="/grading" className="text-sm hover:text-gray-400 transition">Grading</a></li>
            <li><a href="/contact" className="text-sm hover:text-gray-400 transition">Contact</a></li>
          </ul>
        </div>
