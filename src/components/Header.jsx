...
export default function Navbar() {
  ...
  // Closes menu when a link is clicked (for mobile)
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-90 flex flex-col items-end md:hidden">
          ...
          <div className="w-full flex flex-col items-center space-y-6 mt-8">
            <Link to="/" className="text-white text-lg font-medium" onClick={handleLinkClick}>
              Home
            </Link>
            <Link to="/presets" className="text-white text-lg font-medium" onClick={handleLinkClick}>
              Presets
            </Link>
            <Link to="/grading/default/submit" className="text-white text-lg font-medium" onClick={handleLinkClick}>
              Grading
            </Link>
